package com.xiaxiao.chinatime.customview;
...
import com.xiaxiao.chinatime.runtimepermission.RuntimePermissionsManager;
...
//            mSwipeRefreshLayout.se
    ...
    public Fragment getItemFragment(int fragmentId) {
        return getSupportFragmentManager().findFragmentById(fragmentId);
    }

    public BmobServer getLocalBmobServer() {
        return new BmobServer.Builder(this).build();
    }
